#' Create a slave object for use as a worker with master objects generated by \code{\link{SVDMaster}}
#' @description \code{SVDSlave} objects are worker objects at each site of
...
#'
#' \describe{
#'   \item{\code{SVDSlave$new(x, stateful=TRUE)}}{Create a new SVD slave object with data x and flag
...
#' Create a master object to control worker objects generated by \code{\link{SVDSlave}}
#' @description \code{SVDMaster} objects instantiate and run a distributed SVD computation
#' @docType class
#' @seealso \code{SVDSlave} which goes hand-in-hand with this object
#' @importFrom R6 R6Class
#' @section Methods:
#'
#' \describe{
